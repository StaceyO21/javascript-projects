...
if(commmandOverride == false)
{
    //fuel and engine check ok launch
    if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking")
    {
        console.log("ENGINE FAILURE IMMINENT!");
    } else
...
If fuelLevel is above 20000 AN 
engineIndicatorLight is NOT red blinking OR commandOverride is true print "Cleared to launch!" Else print "Launch scrubbed!" */

if((fuelLevel > 20000 && engineIndicatorLight !== "red blinking") || commmandOverride == true)
